    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 mt-16">
      <div className="w-full max-w-lg p-8 space-y-6  rounded-md">
        ...
        <p className="text-center text-sm text-gray-600">
          Do you like Bata? You will love Bata Club! Register now! Only for
          members, there are discount coupons, exclusive previews and many other
          advantages.
        </p>
        <form className="space-y-4">
          ...
          <div>
            ...
            <div className="flex">
              ...
              <input
                ...
                name="mobile"
                required
                className="flex-1 block w-full p-2 border border-gray-300 rounded-none rounded-r-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
              />
              <button
                type="button"
                className="ml-2 px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                Send OTP
              </button>
            </div>
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              The password should be at least 9 characters long and must contain
